//! Port of `org.apache.lucene.internal.hppc.FloatCursor`.

use std::fmt::{self, Display, Formatter};

/// Port of `org.apache.lucene.internal.hppc.FloatCursor`.
///
/// Forked by Lucene from HPPC, holding an `int` index and a `float` value.
///
...
impl FloatCursor {
    ...
    pub fn new(index: i32, value: f32) -> Self {
        Self { index, value }
    }
}

impl Display for FloatCursor {
